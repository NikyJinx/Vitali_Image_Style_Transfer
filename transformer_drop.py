...
class TransformerNetwork(nn.Module):
    """Feedforward Transformation Network with Dropout
...
class TransformerNetworkTanh(TransformerNetwork):
    ...
    def __init__(self, tanh_multiplier=150, dropout_rate=0.5):
        super(TransformerNetworkTanh, self).__init__(dropout_rate)
